...
export const ProfileCard: React.FC<TProfileCardProps> = ({ data }) => {
  const { username, email, phone, avatarUrl = 'https://i.pravatar.cc/150?img=12', _id = '' } = data;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        {/* Follow Button */}
        <TouchableOpacity style={[styles.followButton]} activeOpacity={0.8} onPress={onSendFriend}>
