    ...
    <View style={styles.card}>
      <View style={styles.content}>
        ...
        <View style={styles.actionButtons}>
          ...
          >
            <EntypoIcon name="pencil" size={20} color={Colors.primary} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={onDeleteTask}>
            <EntypoIcon name="trash" size={20} color={Colors.primary} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={onUpdateComplete}>
            <EntypoIcon name="check" size={20} color={check ? Colors.primary : '#d8d5d5ff'} />
          </TouchableOpacity>
        </View>
      </View>
    </View>
